...
const buttonVariants = cva(
  "inline-flex items-center justify-center border !text-heading4 text-white  whitespace-nowrap rounded-[2px] font-normal uppercase transition-colors focus-visible:outline-none dark:bg-white gap-x-[12px] px-[32px] h-[56px] ",
  {
    variants: {
      variant: {
        primary:
